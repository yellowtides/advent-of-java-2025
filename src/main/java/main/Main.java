...
public class Main {
    ...
    private static final List<Composer<?>> COMPOSERS = List.of(
        ...
        new Composer<>(Day.DAY_08, new Day08Parser(), new Day08Solver())
    );
